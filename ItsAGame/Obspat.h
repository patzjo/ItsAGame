...
enum EVENT_TYPE { E_ERROR, E_START_OVERLAP, E_END_OVERLAP, E_INPUT, E_DAMAGE_TAKEN, E_COLLISION_WITH_LEVEL, E_REMOVE_GAMEOBJECT, E_INFORM_GAMEOBJECT_REMOVED, E_PLAY_SOUND };
